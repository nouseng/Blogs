...
- [`FOWT/dynamic-mooring-6dof`](FOWT/dynamic-mooring-6dof) — *It Moves Now — Dynamic Mooring in
  6DOF.* A full 6DOF Modelica MultiBody floating turbine, exported as an FMI 2.0 co-simulation FMU
  and driven from Python under wind and wave loading, comparing the analytical catenary against
